...
async function main() {
    ...
    // It was hitting recursion error while inferring zod schema
    type ReviewType = z.infer<typeof review>;
    const structuredData = model.withStructuredOutput<ReviewType>(review as any);
